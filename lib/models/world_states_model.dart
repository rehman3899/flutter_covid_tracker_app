// Ignore unnecessary getters and setters warnings for this file
// ignore_for_file: unnecessary_getters_setters

// Model class for storing world states data
class WorldStatesModel {
  ...
  // Constructor for initializing the model with optional parameters
  WorldStatesModel(
      {int? updated,
      int? cases,
      int? todayCases,
    ...
    // Initialize private fields with provided values if not null
    if (updated != null) {
      _updated = updated;
    }
    if (cases != null) {
